...
Chrome           & \begin{tabular}[c]{@{}l@{}}NextDNS\\ Google Public DNS\\ Cloudflare\\ CleanBrowsing\\ OpenDNS\end{tabular}                                                            \\ \midrule
Firefox          & \begin{tabular}[c]{@{}l@{}}NextDNS\\ Cloudflare\end{tabular}                                                                                                          \\ \midrule
Edge             & \begin{tabular}[c]{@{}l@{}}NextDNS\\ Google Public DNS\\ Cloudflare\\ CleanBrowsing\\ OpenDNS\\ Quad9\end{tabular}                                                    \\ \midrule
Opera            & \begin{tabular}[c]{@{}l@{}}Google Public DNS\\ Cloudflare\\ Cloudflare for Families (No Malware)\\ Cloudflare for Families (No Malware or Adult Content)\end{tabular} \\ \midrule
Brave            & \begin{tabular}[c]{@{}l@{}}NextDNS\\ Google Public DNS\\ Cloudflare\\ CleanBrowsing\\ OpenDNS\\ Quad9\end{tabular}                                                    \\ \bottomrule
\end{tabular}
\end{table}
