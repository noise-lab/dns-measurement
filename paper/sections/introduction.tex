...
manipulated to re-direct users to malicious websites~\cite{jones2016detecting}.  To
...
Various previous studies have measured encrypted DNS performance, but they have mostly focused on mainstream DNS resolvers~\cite{hounsel2020comparing,hounsel2021can,hoang2020k,lu2019end-to-end}.
