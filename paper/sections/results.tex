...
\begin{figure*}[t!]
    ...
    \subfigure[North American resolvers]{%
        \includegraphics[width=0.31\textwidth]{figures/100_North_America.png}
    }
    \hfill
    \subfigure[Asian resolvers]{%
        \includegraphics[width=0.31\textwidth]{figures/100_Asia.png}
    }
    \hfill
    \subfigure[European resolvers]{%
        \includegraphics[width=0.31\textwidth]{figures/100_Europe.png}
    }
