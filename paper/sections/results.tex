...
156 ms.
\AH{The performance of the slowest Asia-to-Asia measurement seems like an anomaly. The next-slowest resolver has a median response time of ~1,000 ms. I feel like we should say something about this observation.}
